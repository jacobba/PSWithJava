...
import me.jacoblu.pswithjava.methods.*;
...
public class MainFrame {
	...
	public static JFrame jf_main = null;
	...
	public MainFrame() {
		...
		jf_main.setDefaultCloseOperation(WindowConstants.DO_NOTHING_ON_CLOSE);
		isEnable(false);
		...
		//文件-保存 按钮监听器
		jmi_file_save.addActionListener((ActionEvent e) -> Tools.saveFile(bi, jf_main));
		...
		//编辑-重置图像 按钮监听器
		jmi_edit_restore.addActionListener((ActionEvent e) -> {
			restoreImage();
			jf_main.setTitle("Photoshop");
		});
		//查看-图像直方图 按钮监听器
