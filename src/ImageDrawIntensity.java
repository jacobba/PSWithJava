...
class ImageDrawIntensity {
    ...
    ImageDrawIntensity(BufferedImage bi){
        this.bi = bi;
        getValue();
        getMaxValue();
        gray_output();
    ...
    BufferedImage histogram_equalization_RGB(){
    ...
    BufferedImage getGray_output() {
        return gray_output;
    }

    BufferedImage getGreen_output() {
        return green_output;
    }

    BufferedImage getRed_output() {
        return red_output;
    }
